function store(input) {
    ...
    let result = 0; // променлива, която е контейнер; спомагателна

    if (town === "Sofia") { // основната конструкция най-добре да е тази с най-малко променливи (София, Пловдив, Варна)
